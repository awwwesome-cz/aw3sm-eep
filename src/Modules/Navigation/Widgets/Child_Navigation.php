...
use AwwwesomeEEP\Widget_Border;
...
class Child_Navigation extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        // border style
        $this->add_border_style_controls([
            'border' => '{{WRAPPER}} .child-navigation-container',
            'box_shadow' => '{{WRAPPER}} .child-navigation-container',
            'border_hover' => '{{WRAPPER}} .child-navigation-container:hover',
            'box_shadow_hover' => '{{WRAPPER}} .child-navigation-container:hover',
            'border_radius' => [
                '{{WRAPPER}} .child-navigation-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
            'border_radius_hover' => [
                '{{WRAPPER}} .child-navigation-container:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
            'border_hover_transition' => [
                '{{WRAPPER}} .child-navigation-container' => 'transition: border {{SIZE}}s, border-radius {{SIZE}}s, box-shadow {{SIZE}}s',
            ],
        ]);
    ...
    protected function add_box_style_controls()
    {
        $this->start_controls_section(
            'style_box',
            [
                'label' => __('Box Display', 'aw3sm-eep'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render()
    {
        ...
        // Get the top page id.
        $top_page = $post_ancestors ? end($post_ancestors) : ($post->ID ?? null);
    ...
    protected function add_title_style_control(): void
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .child-navigation-inner .title',
            ]
        );
